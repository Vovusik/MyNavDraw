...
public class TableGrapesFragment extends Fragment  implements SearchView.OnQueryTextListener {


    static TableGrapesFragment newInstance() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        grapes = DbAdapter.getTableGrapes();
