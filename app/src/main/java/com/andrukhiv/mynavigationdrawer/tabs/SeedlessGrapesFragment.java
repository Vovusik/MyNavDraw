...
public class SeedlessGrapesFragment extends Fragment  implements SearchView.OnQueryTextListener {


    static SeedlessGrapesFragment newInstance() {
  ...
  int numColumns = getResources().getInteger(R.integer.search_results_columns);
        ...
        grapes = DbAdapter.getSeedlessGrapes();
