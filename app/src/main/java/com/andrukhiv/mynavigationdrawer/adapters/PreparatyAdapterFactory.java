...
public abstract  class PreparatyAdapterFactory<
        TFIRSTHEADER, VFIRSTHEADER extends View & PreparatyAdapterFactory.FirstHeaderBinder<TFIRSTHEADER>,
        THEADER, VHEADER extends View & PreparatyAdapterFactory.HeaderBinder<THEADER>,
        TBODY,
        VFIRSTBODY extends View & PreparatyAdapterFactory.FirstBodyBinder<TBODY>,
        VBODY extends View & PreparatyAdapterFactory.BodyBinder<TBODY>,
        VSECTION extends View & PreparatyAdapterFactory.SectionBinder<TBODY>
    ...
    public PreparatyAdapterFactory(Context context) {
    }
