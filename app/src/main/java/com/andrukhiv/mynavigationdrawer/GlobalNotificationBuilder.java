 ...
 *
 *  IMPORTANT ПРИМЕЧАНИЕ 1. Вы не должны сохранять / изменять полученный объект уведомления, используя
 ...
 *
 *  IMPORTANT ПРИМЕЧАНИЕ 2. Если глобальный построитель уведомлений потерян из-за того, что процесс завершен, вы
 * должен иметь способ воссоздать Notification Builder из постоянного состояния. (Мы делаем это как
 * хорошо в примере, проверьте IntentServices.)
 */
